...
local CallbackHandler = APkg and APkg.tPackage or {}
...
function CallbackHandler:OnLoad() end
-- No dependencies
function CallbackHandler:OnDependencyError(strDep, strError) return false end

Apollo.RegisterPackage(CallbackHandler, MAJOR, MINOR, {})